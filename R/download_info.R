...
d0 <- bind_rows(googlesheets4::read_sheet(roster_google_id, sheet="Participant Info", skip=1),
                googlesheets4::read_sheet(roster_google_id, sheet="Retired (and off email list)", skip=1)) |>
